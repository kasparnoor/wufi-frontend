...
export const useCheckoutStoreEnhanced = create<CheckoutState>()(
  persist(
    (set, get) => ({
      ...initialState,
      ...
      nextStep: () => {
        // Clear any pending auto-advancement when manually navigating
        get().clearAutoAdvanceTimeout()
    ...
    {
      name: 'wufi-checkout-store-enhanced',
      partialize: (state) => ({
...
export const useOnlineStatus = () => {
  const setOnlineStatus = useCheckoutStoreEnhanced(state => state.setOnlineStatus)
