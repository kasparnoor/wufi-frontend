...
import { ArrowRightMini, XMark, MagnifyingGlass } from "@medusajs/icons"
              ...
              <div className="relative flex h-full">
                <Popover.Button
                  ...
                  className={`relative h-full flex items-center transition-all ease-out duration-200 text-base font-medium
                    ${isScrolled ? "hover:text-yellow-600" : "hover:text-yellow-400"}`}
                >
                  Menüü
                </Popover.Button>
              </div>
                    ...
                    <div>
                      ...
                      <form onSubmit={handleSearch} className="mb-8">
                        <div className="relative">
                          ...
                          >
                            <MagnifyingGlass className="h-4 w-4 text-black" />
                          </button>
                        </div>
                      </form>
